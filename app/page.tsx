          ...
          <div className="flex max-w-full items-center gap-1.5 overflow-visible rounded-full bg-white/75 p-1.5 shadow-sm ring-1 ring-stone-200/70 backdrop-blur">
            ...
            <div className="relative flex shrink-0 items-center gap-1.5">
              ...
              <button
                ...
                disabled={!canUndo}
                className="h-7 shrink-0 rounded-full px-2.5 text-[11px] font-medium disabled:opacity-35"
                style={{ color: canUndo ? '#7E9B86' : '#a8a29e', background: canUndo ? '#E4ECE6' : '#f5f5f4', touchAction: 'manipulation' }}
            ...
            {widgetPrefs.doctorNotes !== false && (
              <button onClick={() => { setDoctorNotesStartNew(true); setShowDoctorNotes(true); }} className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full p-0 leading-none" style={{ background: '#E4ECE6', border: '1px solid #CAD9CF', color: '#476653', touchAction: 'manipulation' }} title="Doctor notes" aria-label="Doctor notes">
