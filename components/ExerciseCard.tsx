        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-baseline gap-1 min-w-0">
              ...
              {exercise.optional && <span className="flex-shrink-0 text-xs text-stone-400">(optional)</span>}
              <button
                type="button"
                onClick={(e) => { e.stopPropagation(); setTypeDraft(normalizeExerciseType(exercise.cat)); setShowTypePicker(true); }}
                className="inline-flex flex-shrink-0 items-baseline rounded px-0.5 text-[10px] font-black uppercase tracking-[0.12em] leading-none transition-colors"
                style={{
