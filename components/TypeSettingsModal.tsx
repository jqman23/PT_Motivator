...
const EMOJI_GROUPS: EmojiGroup[] = [
  ...
  { label: 'Body', items: [
    ...
    emojiItem('🫁', 'lungs|breathing|respiratory|chest'),
    emojiItem('🦷', 'jaw|teeth|tmj'),
    emojiItem('👄', 'mouth|jaw|speech'),
    emojiItem('👅', 'tongue|swallow|speech'),
    emojiItem('👤', 'head|neck|posture'),
    emojiItem('🧍‍♀️', 'stand|standing|posture|balance'),
    emojiItem('🧍‍♂️', 'stand|standing|posture|balance'),
    emojiItem('🧎‍♀️', 'kneel|kneeling|floor|mobility'),
    emojiItem('🧎‍♂️', 'kneel|kneeling|floor|mobility'),
    emojiItem('🤲', 'hands|support|grip|cup'),
    emojiItem('👊', 'fist|grip|hand|strength'),
    emojiItem('👇', 'down|foot|lower'),
    emojiItem('👆', 'up|reach|finger'),
  ...
  { label: 'Medical', items: [
    ...
    emojiItem('🩼', 'crutch'),
    emojiItem('🦯', 'cane|walking aid|gait'),
    emojiItem('🧑‍🦽', 'wheelchair|mobility|rehab'),
    emojiItem('🧑‍🦯', 'cane|walking aid|mobility'),
    emojiItem('🧑‍⚕️', 'physical therapist|doctor|clinician|rehab'),
    emojiItem('🧬', 'body|biology|recovery'),
